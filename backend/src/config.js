...
export function loadConfig(env = process.env) {
  ...
  return {
    ...
    model: env.TUTOR_MODEL || 'gpt-5.6-luna',
    ...
    premiumLiveDailySeconds: Math.max(0, num('PREMIUM_LIVE_DAILY_SECONDS', 1800)),
    standardDailySeconds: Math.max(0, num('STANDARD_DAILY_SECONDS', 300)),
