      ...
      cloudflareTest({
        ...
        miniflare: {
          bindings: {
            ...
            DEV_MODE: '1',
            TUTOR_PROVIDER: 'mock',
            STANDARD_PROVIDER: 'mock',
            PLAN_POLICY_JSON: JSON.stringify({ FREE: { childProfileLimit: 6 }, FAMILY: { childProfileLimit: 6 }, PREMIUM: { childProfileLimit: 6 }, PREMIUM_PLUS: { childProfileLimit: 6 } }),
